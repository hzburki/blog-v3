...
<BlogImage
  client:load
  extendWidth
  alt="Preference Screen - AWS Console"
  caption="Preference Screen - AWS Console"
  src="/static/post-images/first-aws-billing-alarm/billing-preferences.png"
/>
...
<BlogImage
  client:load
  extendWidth
  alt="Specify Metrics - AWS Console"
  caption="Specify Metrics - AWS Console"
  src="/static/post-images/first-aws-billing-alarm/billing-specify-metrics.png"
/>
...
<BlogImage
  client:load
  extendWidth
  alt="Creating SNS Topic - AWS Console"
  caption="Creating SNS Topic - AWS Console"
  src="/static/post-images/first-aws-billing-alarm/billing-sns-topic.png"
/>
