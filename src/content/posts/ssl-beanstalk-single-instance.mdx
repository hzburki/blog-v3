...
<Image
  client:load
  extendWidth
  alt="Elastic Beanstalk Configuration Tab"
  caption="Elastic Beanstalk Configuration Tab"
  src="/static/post-images/ssl-beanstalk-single-instance/beanstalk-config-screen.png"
/>
...
<Image
  client:load
  extendWidth
  alt="SSL Certificate Results"
  caption="SSL Certificate Results"
  src="/static/post-images/ssl-beanstalk-single-instance/ssl-cert-results.png"
/>
